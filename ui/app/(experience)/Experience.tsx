...
export function Experience() {
    ...
    return <div id="exp" className="py-32 px-8 md:py-48 md:px-32 flex flex-col items-center">
        <div className="text-5xl md:text-6xl font-medium"><span>Experience</span></div>
        <div className="bg-[#0EA5E9] h-[4px] w-[66px] mt-4 mb-8 md:mt-4 md:mb-16"></div>
