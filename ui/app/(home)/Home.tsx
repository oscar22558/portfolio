...
export function Home(){
    return <div id='home' className={`section-container flex flex-col justify-start items-center ${style["container"]} relative`}>        <div className={`${style["bg-layer"]} absolute inset-0 z-0`}></div>
        <SectionTopSpacer />
